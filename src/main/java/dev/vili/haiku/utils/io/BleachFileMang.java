 ...
 */
package dev.vili.haiku.utils.io;
...
public class BleachFileMang {
	...
	public static String readFile(String path) {
		try {
			...
			HaikuLogger.logger.error("Error Reading File: " + path, e);
		}
	...
	public static void createFile(String path) {
		try {
			...
			HaikuLogger.logger.error("Error Creating File: " + path, e);
		}
	}
	...
	public static void createEmptyFile(String path) {
		try {
			...
			HaikuLogger.logger.error("Error Clearing/Creating File: " + path, e);
		}
	}
	...
	public static void appendFile(String path, String content) {
		try {
			...
			HaikuLogger.logger.error("Error Appending File: " + path, e);
		}
	}
	...
	public static void deleteFile(String path) {
		try {
			...
			HaikuLogger.logger.error("Error Deleting File: " + path, e);
		}
	}
}
