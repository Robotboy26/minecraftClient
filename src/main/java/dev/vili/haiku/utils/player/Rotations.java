...
package dev.vili.haiku.utils.player;

import dev.vili.haiku.Haiku;
import dev.vili.haiku.event.events.entity.player.SendMovementPacketsEvent;
import dev.vili.haiku.eventbus.HaikuSubscribe;
import dev.vili.haiku.event.events.TickEvent;
import dev.vili.haiku.utils.PreInit;
import dev.vili.haiku.utils.entity.Target;
...
public class Rotations {
    ...
    public static void init() {
        Haiku.getInstance().getEventBus().register(Rotations.class);
    }
