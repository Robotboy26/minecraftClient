package dev.vili.haiku.utils.thunderClient.utility.render.shaders;
...
import dev.vili.haiku.utils.thunderClient.utility.render.WindowResizeCallback;
...
public class GradientGlowProgram extends GlProgram {
    ...
    public GradientGlowProgram() {
        super(new Identifier("thunderhack", "gradientglow"), VertexFormats.POSITION);
