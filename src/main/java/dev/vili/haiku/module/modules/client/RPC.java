...
// import dev.vili.haiku.utils.thunderClient.utility.discord.DiscordRPC;
// import dev.vili.haiku.utils.thunderClient.utility.discord.DiscordRichPresence;
...
//     public static ModeSetting mode = new ModeSetting("Mode", "Mode", "default", "default");
//     public static BooleanSetting showIP = new BooleanSetting("ShowIP", "Weather you want to show the IP." true);
...
//     public static BooleanSetting nickname = new BooleanSetting("Nickname", "Nickname", true);
...
//     public RPC() {
//         super("DiscordRPC", "DiscordRPC", GLFW.GLFW_KEY_UNKNOWN, Category.CLIENT);
//         instance = this;
//     }
