...
import dev.vili.haiku.module.modules.render.xray.utils.GuiUtils.HSLResult;
...
public class ColorSelector extends XrayScreen {
    ...
    private static final Identifier PICKER_S_RESOURCE = new Identifier(XRay.MOD_ID, "picker_hl");
    private static final Identifier PICKER_HL_RESOURCE = new Identifier(XRay.MOD_ID, "picker_s");
