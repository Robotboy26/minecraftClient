package dev.vili.haiku.module.modules.render.xray;

import com.mojang.blaze3d.systems.RenderSystem;

import dev.vili.haiku.module.modules.render.xray.color.ColorSupplier;
import dev.vili.haiku.module.modules.render.xray.color.IColorObject;
import dev.vili.haiku.module.modules.render.xray.color.TextHudBuffer;
import dev.vili.haiku.module.modules.render.xray.config.*;
import dev.vili.haiku.module.modules.render.xray.screen.XrayMenu;
import dev.vili.haiku.module.modules.render.xray.utils.GuiUtils;
import dev.vili.haiku.module.modules.render.xray.utils.KeyInput;
import dev.vili.haiku.module.modules.render.xray.utils.RenderUtils;
import dev.vili.haiku.module.modules.render.xray.utils.XrayUtils;
import dev.vili.haiku.module.modules.render.xray.utils.GuiUtils.RGBResult;
...
public class XRay implements ClientModInitializer, HudRenderCallback, EndTick, AfterEntities {
     ...
     * Set fullBright
     */
    public XRay fullBright(boolean enable) {
     ...
     */
    public XRay internalFullbright() {
        if (fullBrightEnable) {
