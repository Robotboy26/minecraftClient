...
import dev.vili.haiku.module.modules.render.xray.config.ESPConfig;
import dev.vili.haiku.module.modules.render.xray.widget.MenuWidget;
...
public class XrayMenu extends XrayScreen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        stack.scale(4, 4, 1);
        context.drawCenteredTextWithShadow(client.textRenderer, XRay.MOD_NAME, 0, -client.textRenderer.fontHeight,
                0xffffff33);
        stack.pop();
        context.drawCenteredTextWithShadow(client.textRenderer, Text.translatable("x13.mod.by",
                        String.join(", ", XRay.MOD_AUTHORS)),
