 ...
 */
package dev.vili.haiku.MixinResources.altmanager;
...
import dev.vili.haiku.MixinResources.altmanager.exceptions.APIDownException;
import dev.vili.haiku.MixinResources.altmanager.exceptions.APIErrorException;
import dev.vili.haiku.MixinResources.altmanager.exceptions.InvalidResponseException;
import dev.vili.haiku.MixinResources.altmanager.exceptions.InvalidTokenException;
...
public class AltManager {
	...
	public void saveAlts() {
		...
		try {
			// Finds the file and opens it.
			File altFile = new File(mc.runDirectory, "aoba_alts.txt");
			System.out.println("[Haiku] Saving Alts");
