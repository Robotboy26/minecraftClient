...
import dev.vili.haiku.setting.settings.Bind;
    ...
    public void render(MatrixStack stack, int MouseX, int MouseY) {
        ...
        if (listening_bind) {
            Render2DEngine.drawRound(stack, posX + 5, posY + 5, 40, 20, 3, Color.BLACK);
                ...
                if (!holdbind) {
                    Render2DEngine.drawRound(stack, posX + 6, posY + 6, 38, 8, 2, Render2DEngine.injectAlpha(ThunderHackGui.onColor1.getColorObject(), 255));
                    ...
                    Render2DEngine.drawRound(stack, posX + 6, posY + 16, 38, 8, 2, Render2DEngine.injectAlpha(ThunderHackGui.onColor1.getColorObject(), 255));
