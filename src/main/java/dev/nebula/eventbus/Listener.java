...
public final class Listener {
    ...
    private final Consumer<NebulaEvent> lambda;

    public Listener(final Object listenerClass, final Method method, final Consumer<NebulaEvent> lambda) {
     ...
     * @return lambda
     */
    public Consumer<NebulaEvent> getLambda() {
        return lambda;
    }
