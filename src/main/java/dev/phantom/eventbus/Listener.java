...
public final class Listener {
    ...
    private final Consumer<PhantomEvent> lambda;

    public Listener(final Object listenerClass, final Method method, final Consumer<PhantomEvent> lambda) {
     ...
     * @return lambda
     */
    public Consumer<PhantomEvent> getLambda() {
        return lambda;
    }
